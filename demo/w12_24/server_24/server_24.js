...
import { blogs_24 } from './dataBlogs_24.js';

let taskList = tasks;
let blogList_24 = blogs_24;
...
app.get('/api/blogs', (req, res) => {
  res.json({ blogList_24 });
});

app.post('/api/blogs/loadAll', (req, res) => {
  blogList_24 = blogs_24;
  console.log('blogList_24', JSON.stringify(blogList_24));
...
app.post('/api/blogs', (req, res) => {
  ...
  blogList_24 = [...blogList_24, newBlog];
...
app.patch('/api/blogs/:id', (req, res) => {
  ...
  blogList_24 = blogList_24.map((item)=>{
    if(item.id == id){
...
app.delete('/api/blogs/:id', (req, res) => {
  const { id } = req.params;
  blogList_24 = blogList_24.filter((item) => item.id != id);
  console.log('blogList_24', blogList_24);
